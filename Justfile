...
doctor:
    @echo "Running diagnostics for MinixSDK.jl..."
...
help-me:
    @echo "=== MinixSDK.jl Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/MinixSDK.jl/issues/new"
    @echo ""
